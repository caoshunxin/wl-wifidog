...
#define DEFAULT_DEBUGLEVEL LOG_ERR //LOG_INFO
...
#define DEFAULT_GATEWAYPATH "/"  //for our web server path
...
#define DEFAULT_AUTHSERVTOKEN "100001"  //token
#define DEFAULT_AUTHSERVPATH "/wifidog/"
#define DEFAULT_AUTHSERVLOGINPATHFRAGMENT "http://m.wo-lan.com/wechatLogin/index"
#define DEFAULT_AUTHSERVPORTALPATHFRAGMENT "http://m.wo-lan.com/"
#define DEFAULT_AUTHSERVERRORFRAGMENT "lisa/error.json?"
#define DEFAULT_AUTHSERVMSGPATHFRAGMENT "gw_message.php?"
#define DEFAULT_AUTHSERVPINGPATHFRAGMENT "ping/?"
#define DEFAULT_AUTHSERVAUTHPATHFRAGMENT "lisa/dev_phone_pass.json"
#define DEFAULT_AUTHSERVAUTHALLOWPATHFRAGMENT "http://m.wo-lan.com/wechatLogin/auth"
#define DEFAULT_AUTHREDIRECTPATH "cms/resource/loginalready.html?reurl="
/*@}*/ 
...
typedef struct _auth_serv_t {
    ...
    char *authserv_token;    /**< @brief  token */
    ...
    char *authserv_auth_allow_path_fragment;	/*added by caosx 20160617 */
    int authserv_http_port;	/**< @brief Http port the central server
				     listens on */
    int authserv_cmshttp_port;	/**< @brief Http port the central server
				     listens on */
...
typedef struct {
    ...
    char *gw_address;		/**< @brief Internal IP address for our web
				     server */
    char *gw_path;	  /**< @brief Path where our web server*/
    int gw_port;		/**< @brief Port the webserver will run on */
    
    char *portal_type;	/**< @brief portal type */
    ...
    char *gnuversion;		/*gnuversion  */
    char *gw_mac;	  /**gateway device mac address*/
} s_config;
...
void gnuversion_read(void); 
void gatewaymac_read(void); 
