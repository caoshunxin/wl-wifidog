...
void http_callback_xh404(httpd *webserver, request *r);
...
void http_callback_xhauth(httpd *webserver, request *r);

void http_callback_weixin(httpd *webserver, request *r);
