...
void httpd_send200  __ANSI_PROTO((request*));
void httpd_sendwx  __ANSI_PROTO((request*));
void httpd_send200c  __ANSI_PROTO((request*,char*));
void httpd_sendno200  __ANSI_PROTO((request*));
void httpd_ky_send200  __ANSI_PROTO((request*));
