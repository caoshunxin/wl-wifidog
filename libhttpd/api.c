	...
	struct	timeval *timeout;
{
	...
	/* Reset error */
	server->lastError = 0;  //added by caosx 20160927
	FD_ZERO(&fds);
...
void httpd_sendwx(request *r)
{
	_httpd_sendwx(r);
}

void httpd_send200c(request *r,char *msg)
{
	_httpd_send200c(r,msg);
}
void httpd_send200(request *r)
{
	_httpd_send200(r);
}


void httpd_sendno200(request *r)
{
	_httpd_sendno200(r);
}

void httpd_ky_send200(request *r)
{
        _httpd_ky_send200(r);
}
